...
public class RowBoundsPlugin extends PluginAdapter {
    ...
    private void copyAndAddMethod(Method method, Interface interfaze) {
        ...
        newMethod.getBodyLines().addAll(method.getBodyLines());
        newMethod.setConstructor(method.isConstructor());
        newMethod.getExceptions().addAll(method.getExceptions());
        ...
        newMethod.getAnnotations().addAll(method.getAnnotations());
        newMethod.setFinal(method.isFinal());
        newMethod.setStatic(method.isStatic());
        newMethod.getJavaDocLines().addAll(method.getJavaDocLines());
    ...
    private void copyAndSaveElement(XmlElement element, FullyQualifiedTable fqt) {
        XmlElement newElement = new XmlElement(element.getName());
        
        newElement.getAttributes().addAll(element.getAttributes());
        newElement.getElements().addAll(element.getElements());
